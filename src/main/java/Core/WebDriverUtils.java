...
public class WebDriverUtils {
        ...
        try {
            ...
            switch (currentBrowser) {
                ...
                case CHROME:
                    ...
                    System.setProperty("webdriver.chrome.driver", Constants.vChromeBrowserPath);
                ...
                case IE10:
                    ...
                    System.setProperty("webdriver.ie.driver", Constants.vIEBrowserPath);
    ...
    public static WebElement waitForElementToBeClickable(WebElement element, String name) throws Exception {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Constants.TimeOut_Seconds);
    ...
    public static void waitUntilElementIsEnabled(final By elementlocator) throws Exception {
        try {
            new WebDriverWait(driver, Constants.TimeOut_Seconds) {
    ...
    public static void normalizeWaitingTimeForElement() throws Exception {
        try {
            ...
            Log.info("Set the implicit waiting time to " + Constants.TimeOut_Seconds
                    + " seconds");
        } catch (Exception ex) {
            captureScreenShot(driver, new Exception().getStackTrace()[0].getMethodName());
            Log.error(ex.getMessage());
    ...
    public static void goToURL(String url) throws Exception {
        try {
            ...
            //String fullUrl = Constants.URL + url;
